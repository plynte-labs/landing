// Build-time i18n dictionary. Ported verbatim from the former
// src/data/translations.ts — every es/en string preserved exactly, including
// Rioplatense voseo, the "↗"/"→" glyphs, the langToggle inversion (label shows
// the OTHER language), and the verbatim codeExample. This never ships to the
// client; t() resolves at build time per locale.
...
export const ui: Record<Locale, TranslationDict> = {
  es: {
    banner: {
    ...
    footer: {
      builtWith: 'Construido con Astro + React + TypeScript',
    ...
    notFound: {
      ...
      description: 'Esta ruta no existe. ¿Quizás quisiste ir a nuestro GitHub?',
  ...
  en: {
    ...
    footer: {
      builtWith: 'Built with Astro + React + TypeScript',
      license: 'MIT License',
    ...
    notFound: {
      ...
      description: "This route doesn't exist. Maybe you meant to visit our GitHub?",
